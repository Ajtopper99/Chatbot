...
function App() {
  ...
  const handleInput = () => {
    ...
    //   }, 2000);
    ...
    } else if (word8.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "My name is Treasure";
        inputRef.value = ""; // clear the input
      }, 2000);
    } else if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Ankit";
        inputRef.value = ""; // clear the input
      }, 2000);
    } else if (words10.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText ="I'm a chatbot created by my fellow developer friends"
        inputRef.value = ""; // clear the input
      }, 2000);
      ...
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "I am 2 year old";
        inputRef.value = ""; // clear the input
      }, 2000);
    } else {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerHTML =
          "Sorry I don't recognise what you entered<br><img src='ig.png' class='ig' />";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
